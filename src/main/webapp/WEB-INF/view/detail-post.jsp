		...
		<div class="container">
			<div class="row align-items-center mb-5">
					...
					<div class="d-flex align-items-center">
						<div class="border p-2 d-inline-block mr-3 rounded">
							<img width="100" height="100"
								src="${pageContext.request.contextPath}/resources/images/${recruitment.company.logo}"
								alt="Image">
						</div>
						<div>
							<h2>${recruitment.company.nameCompany}</h2>
							<div>
								<span class="icon-briefcase mr-2">${recruitment.company.email}</span><a
									class="ml-0 mr-2 mb-2"></a> <span class="icon-room mr-2"></span>${recruitment.company.address}<span
									class="m-2"></span>
							</div>
							<input type="hidden">
						</div>
				...
				<div class="col-lg-4">
					<div class="row">
						<div class="col-6">
							<a href="${pageContext.request.contextPath}/saveStatusCompany/${recruitment.company.id}"
							 class="btn btn-block btn-light btn-md"><span
								class="icon-heart-o mr-2 text-danger"></span> <c:if
									test="${recruitment.company.status == 0}">
            						Theo dõi
        					</c:if> <c:if test="${recruitment.company.status == 1}">
           							 Hủy Theo dõi
        					</c:if> </a>
						</div>
						<div class="col-6">
					...
					<div class="bg-light p-3 border rounded mb-4">
						...
						<ul class="list-unstyled pl-3 mb-0">
							...
							<li class="mb-2"><strong class="text-black">Số
									lượng: </strong><span>${recruitment.view}</span></li>
